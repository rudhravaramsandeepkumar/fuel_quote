...
function order_fuel(){
  ...
  var available_quantity=document.getElementById("avl_qvailable").innerHTML
  ...
  if(bdate == ""){
    ...
    document.getElementById("lb_bdate").className = 'required_';
     ...
     let details_={"fuel_type":fuel_type,"quantity_quote":quantity_quote,"Gallon_price":Gallon_price,"Total_Amount_Due":Total_Amount_Due,"bdate":bdate,"cur_gst":cur_gst,'available_quantity':available_quantity}
     $.ajax({
